...
class Ui_Main(object):
    def setupUi(self, Main):
        ...
        self.pushButton_classify.setGeometry(QtCore.QRect(1090, 20, 112, 34))
        self.pushButton_classify.setObjectName("pushButton_classify")
        self.comboBox_type = QtWidgets.QComboBox(self.widget)
        self.comboBox_type.setGeometry(QtCore.QRect(423, 10, 111, 31))
        self.comboBox_type.setObjectName("comboBox_type")
        self.lineEdit_desc = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_desc.setGeometry(QtCore.QRect(86, 15, 251, 25))
        self.lineEdit_desc.setObjectName("lineEdit_desc")
        self.label = QtWidgets.QLabel(self.widget)
        self.label.setGeometry(QtCore.QRect(20, 19, 61, 20))
        ...
        self.lineEdit_tag.setGeometry(QtCore.QRect(86, 56, 251, 25))
        self.lineEdit_tag.setObjectName("lineEdit_tag")
        self.comboBox_level = QtWidgets.QComboBox(self.widget)
        self.comboBox_level.setGeometry(QtCore.QRect(423, 53, 111, 31))
        self.comboBox_level.setObjectName("comboBox_level")
        self.label_3 = QtWidgets.QLabel(self.widget)
        self.label_3.setGeometry(QtCore.QRect(360, 17, 61, 20))
        self.label_3.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.widget)
        self.label_4.setGeometry(QtCore.QRect(360, 58, 61, 20))
        self.label_4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.widget)
        self.label_5.setGeometry(QtCore.QRect(571, 14, 61, 20))
        self.label_5.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_5.setObjectName("label_5")
        self.lineEdit_desc_2 = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_desc_2.setGeometry(QtCore.QRect(637, 10, 100, 25))
        self.lineEdit_desc_2.setObjectName("lineEdit_desc_2")
        self.label_6 = QtWidgets.QLabel(self.widget)
        self.label_6.setGeometry(QtCore.QRect(571, 54, 61, 20))
        self.label_6.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_6.setObjectName("label_6")
        self.lineEdit_desc_3 = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_desc_3.setGeometry(QtCore.QRect(637, 50, 100, 25))
        self.lineEdit_desc_3.setObjectName("lineEdit_desc_3")
        self.lineEdit_path = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_path.setEnabled(True)
        self.lineEdit_path.setGeometry(QtCore.QRect(86, 96, 651, 25))
        self.lineEdit_path.setReadOnly(True)
        self.lineEdit_path.setObjectName("lineEdit_path")
        self.label_7 = QtWidgets.QLabel(self.widget)
        self.label_7.setGeometry(QtCore.QRect(20, 100, 61, 20))
        self.label_7.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_7.setObjectName("label_7")
        self.dateTimeEdit_publish = QtWidgets.QDateTimeEdit(self.widget)
        self.dateTimeEdit_publish.setGeometry(QtCore.QRect(880, 10, 150, 25))
        self.dateTimeEdit_publish.setFrame(True)
        self.dateTimeEdit_publish.setReadOnly(True)
        self.dateTimeEdit_publish.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.dateTimeEdit_publish.setAccelerated(False)
        self.dateTimeEdit_publish.setKeyboardTracking(True)
        self.dateTimeEdit_publish.setProperty("showGroupSeparator", False)
        self.dateTimeEdit_publish.setDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 1), QtCore.QTime(3, 4, 5)))
        self.dateTimeEdit_publish.setCalendarPopup(True)
        self.dateTimeEdit_publish.setObjectName("dateTimeEdit_publish")
        self.label_8 = QtWidgets.QLabel(self.widget)
        self.label_8.setGeometry(QtCore.QRect(787, 13, 91, 20))
        self.label_8.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_8.setObjectName("label_8")
        self.dateTimeEdit_create = QtWidgets.QDateTimeEdit(self.widget)
        self.dateTimeEdit_create.setGeometry(QtCore.QRect(880, 47, 150, 25))
        ...
        self.label_9.setGeometry(QtCore.QRect(787, 50, 91, 20))
        self.label_9.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_9.setObjectName("label_9")
        self.dateTimeEdit_update = QtWidgets.QDateTimeEdit(self.widget)
        self.dateTimeEdit_update.setGeometry(QtCore.QRect(880, 87, 150, 25))
        ...
        self.label_10.setGeometry(QtCore.QRect(787, 90, 91, 20))
        self.label_10.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_10.setObjectName("label_10")
        self.pushButton_move = QtWidgets.QPushButton(self.widget)
        self.pushButton_move.setGeometry(QtCore.QRect(1090, 70, 112, 34))
    ...
    def retranslateUi(self, Main):
        ...
        self.label_8.setText(_translate("Main", "发布时间："))
